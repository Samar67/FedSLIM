...
parser.add_argument("--folder_name", type=str, default="none", help="Data Folder Name")
...
# DATA_DIR = Path(f"./data/{DATA_FOLDER}/{DATASET}")
...
try:
    ...
    # Start server
    # =========================
    server_log = open(LOG_DIR / f"fed_server_{DATASET}_72hrs.log", "w")
    ...
    for cid in range(NUM_CLIENTS):
        ...
        client_log = open(LOG_DIR / f"fed_cl{cid}_{DATASET}_72hrs.log", "w")
        # client_log = open(LOG_DIR / f"fed_cl{cid}_{DATASET}_{NUM_CLIENTS}cl.log", "w")
